# AK Homepage 2026 – Section build (Figma: AK_Homepage Launch 2026_Desktop)

Sections built to match the Figma design. Add and order them in **Theme Editor → Homepage**.

## Recommended section order

1. **AK Hero Campaign** – Spring 2026 Campaign / The Invisible Thread / DISCOVER
2. **AK Category Pills** – New for the Season + Clothing, Shoes, Handbags, Watches, Jewelry
...
| Section | File | Notes |
|--------|------|--------|
| AK Hero Campaign | `index__hero-campaign.liquid` | Hero image, preheading, Amiri heading, CTA link |
